...
#### State:
- Data is managed within the component itself.
- State is mutable and can be changed within the component using an updater function (e.g., setState or useState).
#### Props:
- Data is passed from a parent component to a child component.
- Props are immutable and read-only; they cannot be modified by the receiving component.
